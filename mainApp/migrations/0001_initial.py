# Generated by Django 3.0.1 on 2019-12-23 15:45
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('promedio_puntuaciones', models.IntegerField(default=0, editable=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('puntuacion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mainApp.Puntuacion')),
        ...
        migrations.AddField(
            ...
            name='puntuacion',
            field=models.ManyToManyField(blank=True, default=4, to='mainApp.Puntuacion'),
        ),
        migrations.AddField(
            model_name='user',
            name='categorias',
            field=models.ManyToManyField(blank=True, to='mainApp.Categoria'),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
        ...
        migrations.AddField(
            model_name='user',
            name='menciones',
            field=models.ManyToManyField(blank=True, editable=False, to='mainApp.Mencion'),
        ),
        migrations.AddField(
            model_name='user',
            name='proyecto',
            field=models.ManyToManyField(default='Por asignar', to='mainApp.Proyecto'),
        ),
        migrations.AddField(
            model_name='user',
